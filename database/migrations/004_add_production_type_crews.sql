-- =====================================================
-- MIGRATION 004: Add Production Type Crews Template Table
-- =====================================================
-- This table stores crew position templates for different production types
-- Used by auto-generate budget feature to create detailed, realistic budgets
-- =====================================================

-- Create production_type_crews table
CREATE TABLE IF NOT EXISTS production_type_crews (
