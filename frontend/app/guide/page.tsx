          ...
          {activeSection === 'union-agreements' && (
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Comprehensive database of 2,400+ union rate cards covering 46 union locals across US and Canada.
                </p>
                ...
                <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-4">
                  <div className="border dark:border-gray-700 rounded-lg p-3">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-300">
                      44, 52, 80, 161, 209, 411, 477, 479, 480, 481, 487, 492, 600, 695, 700, 705, 706, 728, 729, 764, 798, 800, 839, 854, 871, 873, 892, USA829, Videotape
                    </div>
                  </div>
                  ...
                  <div className="border dark:border-gray-700 rounded-lg p-3">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-300">
                      DGA, SAG-AFTRA, WGA, DGC, DGC-BC, UBCP
                    </div>
                  </div>

                  <div className="border dark:border-gray-700 rounded-lg p-3">
                    <div className="text-2xl mb-1">🚚</div>
                    <div className="font-semibold">Transportation & Trades</div>
                    <div className="text-sm text-gray-600 dark:text-gray-300">
                      Teamsters 399, 769, 817, IBEW Local 40, UA Local 78, Local 724, Local 755
                    </div>
                  </div>

                  <div className="border dark:border-gray-700 rounded-lg p-3">
                    <div className="text-2xl mb-1">🍁</div>
                    <div className="font-semibold">Canada (BC)</div>
                    <div className="text-sm text-gray-600 dark:text-gray-300">
                      BCCFU, UBCP, DGC-BC, AFM
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-4 bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                    <li>• 2,400+ total rate cards in database</li>
                    <li>• 46 union locals covered</li>
                    <li>• US (Los Angeles, New York, Atlanta, etc.) and Canada (British Columbia)</li>
                    <li>• Multi-year agreements with annual increases (2024-2028)</li>
